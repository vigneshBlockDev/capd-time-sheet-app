    ...
    return (
        <React.Fragment>
            <nav className="navbar navbar-dark m-5 bg-dark">
                ...
                {localStorage.getItem('isAdmin') === 'true' && <a className="navbar-brand" href="/ManagerForm">   <span><FaProjectDiagram /><p>Manager Time Sheet</p></span></a>}
                <a className="navbar-brand" href="/ResourceForm">   <span><FaProjectDiagram /><p>Resource Time Sheet</p></span></a>
