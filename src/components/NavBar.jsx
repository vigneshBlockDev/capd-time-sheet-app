    ...
    return (
        <React.Fragment>
            <nav className="navbar navbar-dark m-5 bg-dark">
                ...
                <a className="navbar-brand" href="/TimeSheetDetails">   <span><FaProjectDiagram /><p>Time Sheet Table</p></span></a>
                <a className="navbar-brand" href="/Test">   <span><FaProjectDiagram /><p>New Time Sheet Table</p></span></a>
